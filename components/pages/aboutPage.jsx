...
export default function AboutPage() {
    return (
        <div className="bg-white">
            <div className="relative bg-sky-800 p-24 sm:pb-32">
                <div className="absolute inset-0">
                    <img
                        className="h-full w-full object-cover"
                        src="./assets/images/map/library11.jpg"
                        alt=""
                    />
                    <div
                        className="absolute inset-0 bg-gradient-to-l from-sky-200 to-slate-500 mix-blend-multiply"
                        aria-hidden="true"
                    />
                </div>
                ...
                <div className="relative mx-auto mt-24 max-w-md px-6 sm:mt-32 sm:max-w-3xl lg:max-w-7xl lg:px-8">
                    <h1 className="text-4xl font-bold tracking-tight text-gray-300 uppercase sm:text-5xl lg:text-6xl">School library</h1>
                    <p className="mt-2 max-w-3xl text-xl text-gray-200">
                        ...
                        <div className="lg:grid lg:grid-cols-3 lg:gap-8">
                            <div>
                                <h2 className="text-3xl font-bold tracking-tight text-warm-gray-900">
                                    Kamuzu Academy Educational Structure
                                </h2>
