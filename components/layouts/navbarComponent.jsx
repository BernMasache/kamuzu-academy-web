...
const pages = [
    ...
    const company = [
        { name: 'History', href: '/information/history', icon: InformationCircleIcon },
      ]
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between py-5 px-6 sm:py-4 md:justify-start md:space-x-10 lg:px-8">
          ...
          <div className="hidden md:flex md:flex-1 md:items-center md:justify-between">
            <Popover.Group as="nav" className="flex space-x-10">
                {
                    pages.map((page,key)=>{
                       return <Link key={key} href={page.href} className="text-base font-medium text-gray-500 hover:text-gray-900">
                        {page.name}
                      </Link>
                    })
                }
                      ...
                      <Popover.Panel className="absolute inset-x-0 top-full z-10 hidden transform shadow-lg md:block">
                        ...
                        <div className="relative mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
                          <nav className="grid gap-y-10 bg-white px-4 py-8 sm:grid-cols-2 sm:gap-x-8 sm:py-12 sm:px-6 lg:px-8 xl:pr-12">
                            <div>
                              <h3 className="text-base font-medium text-gray-500">Information</h3>
                          ...
                          <div className="bg-gray-50 px-4 py-8 sm:py-12 sm:px-6 lg:px-8 xl:pl-12">
                            <div>
                              <h3 className="text-base font-medium text-gray-500">Background</h3>
        ...
        >
          <div className="divide-y-2 divide-gray-50 rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5">
            ...
            <div className="py-6 px-5">
              ...
              {
                    pages.map((page,key)=>{
                       return <a key={key} href={page.href} className="text-base font-medium text-gray-700 hover:text-gray-900">
                        {page.name}
                      </a>
                    })
                }
