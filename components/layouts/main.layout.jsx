...
const navigation = {
  ...
  pages: [
    { name: 'Home', href: '/home' },
    { name: 'Admissions', href: '/admissons' },
    ...
    <div className="bg-white">
        ...
        <Transition.Root show={mobileMenuOpen} as={Fragment}>
          <Dialog as="div" className="relative z-40 lg:hidden" onClose={setMobileMenuOpen}>
            ...
            <div className="fixed inset-0 z-40 flex">
              ...
              >
                <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-green-800 pb-12 shadow-xl">
          ...
          <nav aria-label="Top">
            ...
            <div className="bg-green-700">
              <div className="mx-auto flex h-10 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
                ...
                <form className="hidden lg:block lg:flex-1">
                  <div className="flex">
                    ...
                    <div className="group relative -ml-2 rounded-md border-transparent focus-within:ring-2 focus-within:ring-white">
                      <h1
                        name="currency"
                        className="flex uppercase items-center rounded-md border-transparent bg-none py-0.5 pl-2 pr-5 text-2xl font-medium text-gray-200 focus:border-transparent focus:outline-none focus:ring-0 group-hover:text-gray-100"
                      >
                        Kamuzu Academy
                      </h1>
                ...
                <p className="sr-only flex-1 text-center text-sm font-medium text-white lg:flex-none">
                  Honor deo et patriate
                </p>
                ...
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  ...
                  <span href="#" className="p-2 text-sm font-medium text-white hover:text-gray-100">
      ...
      <footer className="bg-green-900" aria-labelledby="footer-heading">
        ...
        <div className="mx-auto max-w-7xl py-12 px-6 lg:py-16 lg:px-8">
                ...
                <div>
                  ...
                  <ul role="list" className="mt-4 space-y-4">
                    {footerNavigation.solutions.map((item) => (
                      <li key={item.name}>
                        <a href={item.href} className="text-base text-gray-200 hover:text-gray-300">
                          {item.name}
                        </a>
                      </li>
                    ))}
          ...
          <div className="mt-12 border-t border-gray-00 pt-8">
            <p className="text-base text-gray-200 xl:text-center">
              &copy; {new Date().getFullYear()} KA, Inc. All rights reserved. Developed by Phynocut ICT
            </p>
          </div>
        </div>
      </footer>
...
const AdminLayout = withRouter(MainPage);
